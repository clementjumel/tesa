from database_creation.database import create_database, annotation_task, gather_answers
...
create_database(max_size=max_size, min_articles=min_articles, min_queries=min_queries)
