...
def parse_arguments():
    ...
    ap.add_argument(
        "-b", "--batches", required=True, type=int, help="Number of batches to generate."
    )
    ap.add_argument(
        "-bs", "--batch_size", required=True, type=int, help="Size of the batches to generate."
    )
...
def main():
    ...
    annotation_task.process_annotation_batches(
        batches=args.batches, batch_size=args.batch_size, exclude_pilot=EXCLUDE_PILOT
    )
